...
class Camera(BaseCamera):
    ...
    def frames():
        ...
        with Camera.mp_face_mesh.FaceMesh(
            max_num_faces=1,
                ...
                if results.multi_face_landmarks:
                  for face_landmarks in results.multi_face_landmarks:
                    Camera.mp_drawing.draw_landmarks(
                        ...
                        connections=Camera.mp_face_mesh.FACEMESH_TESSELATION,
                    ...
                    Camera.mp_drawing.draw_landmarks(
                        image=image,
                        landmark_list=face_landmarks,
                        connections=Camera.mp_face_mesh.FACEMESH_CONTOURS,
                        landmark_drawing_spec=None,
                        connection_drawing_spec=Camera.mp_drawing_styles
                    ...
                    Camera.mp_drawing.draw_landmarks(
                        image=image,
                        landmark_list=face_landmarks,
                        connections=Camera.mp_face_mesh.FACEMESH_IRISES,
                        landmark_drawing_spec=None,
                        connection_drawing_spec=Camera.mp_drawing_styles
